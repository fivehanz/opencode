...
- **Still keyframes, character sheets, animatic panels** to feed the video pipeline: use the sibling `image-visual-skills` skill, then return with the keyframes.
