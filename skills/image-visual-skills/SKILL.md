...
description: >
  ...
  Do NOT use for: video (use video-visual-skills), 3D models, audio, non-image tasks.
---
...
- **Motion, clips, montage** (Seedance, Kling, Veo, any image-to-video): use the sibling `video-visual-skills` skill. This skill's storyboard and keyframe outputs feed it.
